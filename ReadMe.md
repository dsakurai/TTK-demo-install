...
To do so execute `TTK-demo-install/install_or_update.sh`. It doesn't matter in which directory you are in. The script will automaticall change the current directory to `TTK-demo-install`.
